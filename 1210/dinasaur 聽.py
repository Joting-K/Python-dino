...
class MyMap:
    ...
    def __init__(self,x,y):
        self.bg=pygame.image.load("D:\Desktop/image/bg.png")
        self.x=x
        self.y=y
...
class Dinasaur:
    def __init__(self):
        ...
        self.floor_y=140     #最低坐标
        self.jumpValue=0      #跳跃增变量
        self.dinasaurIndex=0
        self.dinasaurIndexGen=cycle([0,1,2])
        self.dinasaur_image=(pygame.image.load('D:\Desktop/image/dinosaur1.png').convert_alpha(),
                             pygame.image.load('D:\Desktop/image/dinosaur2.png').convert_alpha(),
                             pygame.image.load('D:\Desktop/image/dinosaur3.png').convert_alpha(),)
        self.jump_audio=pygame.mixer.Sound('D:\Desktop/audio/jump.wav') #加载音效
...
class Obstacle:
    ...
    def __init__(self):
        ...
        self.rect=pygame.Rect(0,0,0,0)
        #加载障碍物的图片
        self.stone=pygame.image.load('D:\Desktop/image/stone.png').convert_alpha() #加载石头
        self.cacti=pygame.image.load('D:\Desktop/image/cacti.png').convert_alpha() #加载仙人掌
        
        self.stone_white=pygame.image.load('D:\Desktop/image/stone_white.png').convert_alpha() #加载石头白
        self.cacti_white=pygame.image.load('D:\Desktop/image/cacti_white.png').convert_alpha() #加载仙人掌白
        
        # 加载分数图片
        self.numbers=(pygame.image.load('D:\Desktop/image/0.png').convert_alpha(), #convert_alpha()透明度
                      pygame.image.load('D:\Desktop/image/1.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/2.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/3.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/4.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/5.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/6.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/7.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/8.png').convert_alpha(),
                      pygame.image.load('D:\Desktop/image/9.png').convert_alpha(),
                      )
        #加载加分的音效
        self.score_audio=pygame.mixer.Sound('D:\Desktop/audio/score.wav')
        
        #加载跳蹲的音效
        self.jump_audio=pygame.mixer.Sound('D:\Desktop/audio/跳.mp3')
        self.do_audio=pygame.mixer.Sound('D:\Desktop/audio/蹲.mp3')
...
#游戏结束的方法
def game_over():
    bump_audio=pygame.mixer.Sound('D:\Desktop/audio/bump.wav')
    bump_audio.play()
    #获取窗口宽高
    screen_w=pygame.display.Info().current_w
    screen_h=pygame.display.Info().current_h
    #加载游戏结束的图片
    over_img=pygame.image.load('D:\Desktop/image/gameover.png').convert_alpha()
    #绘制游戏结束的图标在窗体中间
