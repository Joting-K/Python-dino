...
class GUI():
    ...
    def gui(self):
        ...
        self.explain_button =  tk.Button(self.gui, bg='lightgray' ,command = self.do_explain, text = '遊戲說明',font = ('微軟正黑體',20,"bold"))
        self.explain_button.place(x = 100, y = 550, width = 150)

        self.ok_button =  tk.Button(self.gui, bg='lightgray', command = self.do_ok, text = 'Start',font =  ('微軟正黑體',20,"bold"))
        self.ok_button.place(x = 300, y = 550, width = 150)
        i += 2
        self.ref_button =  tk.Button(self.gui, bg='lightgray',command = self.do_ref, text = '參考資料',font = ('微軟正黑體',20,"bold"))
